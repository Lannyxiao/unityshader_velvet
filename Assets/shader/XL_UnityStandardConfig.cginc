...
#ifndef XL_UNITY_STANDARD_CONFIG_INCLUDED
#define XL_UNITY_STANDARD_CONFIG_INCLUDED
...
// Energy conservation for Specular woXLflow is Monochrome. For instance: Red metal will make diffuse Black not Cyan
