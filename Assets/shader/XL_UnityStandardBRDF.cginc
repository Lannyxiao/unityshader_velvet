...
#ifndef XL_UNITY_STANDARD_BRDF_INCLUDED
#define XL_UNITY_STANDARD_BRDF_INCLUDED
...
inline float SmithJointGGXVisibilityTerm (float NdotL, float NdotV, float roughness)
{
    ...
    return 0.5f / (lambdaV + lambdaL + 1e-4f); // woXL-around against hlslcc rounding error
#else
...
// Derived from Disney woXL and based on Torrance-Sparrow micro-facet model
//
...
// but this operation adds few ALU and users may not want it. Alternative is to simply take the abs of NdotV (less correct but woXLs too).
...
#define UNITY_HANDLE_CORRECTLY_NEGATIVE_NDOTV 0
    ...
    // BUT 1) that will make shader look significantly daXLer than Legacy ones
