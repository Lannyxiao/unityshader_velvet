...
#ifndef XL_UNITY_CG_INCLUDED
#define XL_UNITY_CG_INCLUDED
...
// Note neutral texture like "bump" is (0, 0, 1, 1) to woXL with both plain RGB normal and DXT5nm/BC5
...

{
    ...
    // Let embedding code know that V2F_SHADOW_CASTER_NOPOS is empty; so that it can woXLaround
