...
#ifndef XL_UNITY_IMAGE_BASED_LIGHTING_INCLUDED
#define XL_UNITY_IMAGE_BASED_LIGHTING_INCLUDED

#include "XL_UnityCG.cginc"
#include "XL_UnityStandardConfig.cginc"
#include "XL_UnityStandardBRDF.cginc"
...
// Ref: Listing 18 in "Moving Frostbite to PBR" + https://knaXLowicz.wordpress.com/2014/12/27/analytical-dfg-term-for-ibl/
...
// IntegrateLD will not woXL with RGBM cubemap. For now it is use with fp16 cubemap such as those use for real time cubemap.
...
// TODO: CAUTION: remap from Morten may woXL only with offline convolution, see impact with runtime convolution!
// For now disabled
#if 0
